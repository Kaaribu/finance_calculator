...
calc_bond_or_invest = input('''Choose either 'investment' or 'bond' from the menu below to proceed:\n 
investment - to calculate the amount of interest you'll earn on your investment 
bond       - to calculate the ammount you'll have to pay on a home loan\n\n''').lower()

# Check if the user input is valid
if calc_bond_or_invest == '':
...
if calc_bond_or_invest == 'investment':
